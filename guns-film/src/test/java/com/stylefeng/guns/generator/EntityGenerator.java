...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("/Users/gunannan/IdeaProjects/guns/guns-film/src/main/java");//这里写你自己的java目录
        ...
        strategy.setInclude(new String[]{"mooc_banner_t","mooc_cat_dict_t","mooc_year_dict_t","mooc_film_t","mooc_film_info_t","mooc_actor_t","mooc_film_actor_t","mooc_source_dict_t"});
